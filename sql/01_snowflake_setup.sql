...
SELECT
    cell_tower_id,
    ANY_VALUE(tower_location)                   AS tower_location,
    COUNT(*)                                    AS call_count,
...
/* 
-- =====================================================================
-- 9. Grants for Other existing  role, if required
-- =====================================================================
GRANT USAGE  ON WAREHOUSE CDR_STREAMING_WH_300      TO ROLE AFE;
GRANT USAGE  ON DATABASE  TELCO_ANALYTICS           TO ROLE AFE;
GRANT USAGE  ON SCHEMA    TELCO_ANALYTICS.CDR_STREAMING_300 TO ROLE AFE;

-- Tables
GRANT SELECT, INSERT ON TABLE TELCO_ANALYTICS.CDR_STREAMING_300.CDR_RECORDS_300         TO ROLE AFE;
GRANT SELECT, INSERT ON TABLE TELCO_ANALYTICS.CDR_STREAMING_300.CDR_RECORDS_EVOLVED_300 TO ROLE AFE;
GRANT SELECT, INSERT ON TABLE TELCO_ANALYTICS.CDR_STREAMING_300.CDR_DEAD_LETTER_300     TO ROLE AFE;

-- Pipes
GRANT OPERATE, MONITOR ON PIPE TELCO_ANALYTICS.CDR_STREAMING_300.CDR_STREAMING_PIPE_300       TO ROLE AFE;
GRANT OPERATE, MONITOR ON PIPE TELCO_ANALYTICS.CDR_STREAMING_300.CDR_SCHEMA_EVOLVE_PIPE_300   TO ROLE AFE;
GRANT OPERATE, MONITOR ON PIPE TELCO_ANALYTICS.CDR_STREAMING_300.CDR_DLQ_PIPE_300             TO ROLE AFE;

-- Views
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_STREAMING_LATENCY_300    TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_DLQ_SUMMARY_300          TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_ERROR_RATE_300           TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_ERROR_BY_CHANNEL_300     TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_OFFSET_GAPS_300          TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_TOWER_HEATMAP_300        TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_DEVICE_ANALYTICS_300     TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_SERVICE_TAG_DIST_300     TO ROLE AFE;
GRANT SELECT ON VIEW TELCO_ANALYTICS.CDR_STREAMING_300.V_SCHEMA_EVOLUTION_300     TO ROLE AFE;
